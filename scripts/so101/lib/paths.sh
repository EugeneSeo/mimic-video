...
mimic_video_load_paths() {
  ...
  export MIMIC_VIDEO_EXPERIMENT_ROOT="${MIMIC_VIDEO_EXPERIMENT_ROOT:-${MIMIC_VIDEO_ROOT}/experiments/${MIMIC_VIDEO_EXPERIMENT}}"
  ...
  export MIMIC_VIDEO_EXPERIMENT_CHECKPOINT_ROOT="${MIMIC_VIDEO_EXPERIMENT_CHECKPOINT_ROOT:-${MIMIC_VIDEO_EXPERIMENT_ROOT}/checkpoints}"
  export MIMIC_VIDEO_EXPERIMENT_VIDEO_LORA_DIR="${MIMIC_VIDEO_EXPERIMENT_VIDEO_LORA_DIR:-${MIMIC_VIDEO_EXPERIMENT_CHECKPOINT_ROOT}/video_lora}"
  export MIMIC_VIDEO_DELTA_ACTION_DECODER_DIR="${MIMIC_VIDEO_DELTA_ACTION_DECODER_DIR:-${MIMIC_VIDEO_EXPERIMENT_CHECKPOINT_ROOT}/action_decoder}"
  export MIMIC_VIDEO_ABSOLUTE_ACTION_DECODER_DIR="${MIMIC_VIDEO_ABSOLUTE_ACTION_DECODER_DIR:-${MIMIC_VIDEO_EXPERIMENT_CHECKPOINT_ROOT}/action_decoder_absolute}"
  export MIMIC_VIDEO_EXPERIMENT_ACTION_DECODER_DIR="${MIMIC_VIDEO_EXPERIMENT_ACTION_DECODER_DIR:-${MIMIC_VIDEO_DELTA_ACTION_DECODER_DIR}}"
  export MIMIC_VIDEO_EXPERIMENT_ABSOLUTE_ACTION_DECODER_DIR="${MIMIC_VIDEO_EXPERIMENT_ABSOLUTE_ACTION_DECODER_DIR:-${MIMIC_VIDEO_ABSOLUTE_ACTION_DECODER_DIR}}"
  export MIMIC_VIDEO_EVAL_OUTPUT_ROOT="${MIMIC_VIDEO_EVAL_OUTPUT_ROOT:-${MIMIC_VIDEO_EXPERIMENT_ROOT}/eval_outputs}"
  export MIMIC_VIDEO_LOG_DIR="${MIMIC_VIDEO_LOG_DIR:-${MIMIC_VIDEO_EXPERIMENT_ROOT}/logs}"
  export MIMIC_VIDEO_RUNS_DIR="${MIMIC_VIDEO_RUNS_DIR:-${MIMIC_VIDEO_EXPERIMENT_ROOT}/runs}"
  export MIMIC_VIDEO_VIDEO_LORA_RUN_DIR="${MIMIC_VIDEO_VIDEO_LORA_RUN_DIR:-${MIMIC_VIDEO_RUNS_DIR}/video_lora}"
  export MIMIC_VIDEO_DELTA_ACTION_DECODER_RUN_DIR="${MIMIC_VIDEO_DELTA_ACTION_DECODER_RUN_DIR:-${MIMIC_VIDEO_RUNS_DIR}/action_decoder}"
  export MIMIC_VIDEO_ABSOLUTE_ACTION_DECODER_RUN_DIR="${MIMIC_VIDEO_ABSOLUTE_ACTION_DECODER_RUN_DIR:-${MIMIC_VIDEO_RUNS_DIR}/action_decoder_absolute}"
  export MIMIC_VIDEO_ACTION_DECODER_RUN_DIR="${MIMIC_VIDEO_ACTION_DECODER_RUN_DIR:-${MIMIC_VIDEO_DELTA_ACTION_DECODER_RUN_DIR}}"

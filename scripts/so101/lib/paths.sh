...
mvs_load_paths() {
  ...
  export MVS_EXP_ACTION_DELTA30_DIR="${MVS_EXP_ACTION_DELTA30_DIR:-${MVS_EXP_CHECKPOINT_ROOT}/action_decoder_delta30}"
  ...
  export ACTION_DECODER_KIND="${ACTION_DECODER_KIND:-delta_30hz}"
  ...
  export ACTION_DELTA30_REPO="${ACTION_DELTA30_REPO:-dreamdifferent/mimic-video-so101-2cam-hstack-5fps-w2a-delta30-action-decoder}"
  ...
  export ACTION_DELTA30_FILE="${ACTION_DELTA30_FILE:-checkpoints/model/iter_000005000.pt}"
  ...
  export ACTION_DELTA30_STATS_FILE="${ACTION_DELTA30_STATS_FILE:-stats/so101_delta_30hz_stats.json}"
  ...
  export MVS_ACTION_DELTA30_PATH="${MVS_EXP_ACTION_DELTA30_DIR}/${ACTION_DELTA30_FILE}"
  ...
  export MVS_ACTION_DELTA30_STATS_PATH="${MVS_EXP_ACTION_DELTA30_DIR}/${ACTION_DELTA30_STATS_FILE}"
  ...
  case "${ACTION_DECODER_KIND}" in
    absolute)
      ...
      ;;
    delta_30hz)
      export MVS_ACTION_MODEL_PATH="${MVS_ACTION_DELTA30_PATH}"
      export MVS_ACTION_STATS_PATH="${MVS_ACTION_DELTA30_STATS_PATH}"
      ;;
    relative)

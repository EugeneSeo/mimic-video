...
mimic_video_load_paths() {
  ...
  export MIMIC_VIDEO_PROMPT_EMBEDDING_DIR="${MIMIC_VIDEO_PROMPT_EMBEDDING_DIR:-${MIMIC_VIDEO_EXPERIMENT_ROOT}/prompt_embeddings}"
  export MIMIC_VIDEO_PROMPT_EMBEDDING_MANIFEST_PATH="${MIMIC_VIDEO_PROMPT_EMBEDDING_MANIFEST_PATH:-${MIMIC_VIDEO_PROMPT_EMBEDDING_DIR}/manifest.json}"
  ...
  export MIMIC_VIDEO_PROMPT_EMBEDDING_REPO="${MIMIC_VIDEO_PROMPT_EMBEDDING_REPO:-${PROMPT_EMBEDDING_REPO:-}}"
  export MIMIC_VIDEO_PROMPT_EMBEDDING_FILE="${MIMIC_VIDEO_PROMPT_EMBEDDING_FILE:-${PROMPT_EMBEDDING_FILE:-}}"
...
mimic_video_create_layout() {
  mkdir -p \
    ...
    "${MIMIC_VIDEO_LOG_DIR}" \
    "${MIMIC_VIDEO_PROMPT_EMBEDDING_DIR}" \
